...
# 训练数据
train_dataset = CPDataset('/home/aistudio/train.txt', transform=train_transform)
...
# 验证数据
val_dataset = CPDataset('/home/aistudio/val.txt', transform=eval_transform)
...
model = CPNet(num_classes=num_classes,
            backbone=paddleseg.models.backbones.ResNet50_vd(),
            prior_channels=256,
